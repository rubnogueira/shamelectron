...
export const Kiro: AppMeta = {
  ...
  async checkIsFixed() {
    const url = await fetch(
      ...
      .then((res) => res.json())
      .then((data) => data?.releases?.[0]?.updateTo.url);
